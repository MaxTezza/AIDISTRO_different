...
class ConversationMemory:
    ...
    def recall(self, query, top_k=5):
        ...
        # ⚡ Bolt: First pass - collect matching documents and all needed terms
        rows = conn.execute(
        ...
        # ⚡ Bolt: Batched fetch of doc frequencies for needed terms only
        df_cache = {}
        ...
        # Compute query vector and its magnitude to avoid O(N) redundant operations
