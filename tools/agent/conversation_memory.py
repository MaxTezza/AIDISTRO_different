...
class ConversationMemory:
    ...
    def _update_doc_freq(self, tokens, conn):
        ...
        terms_to_insert = [(term,) for term in unique_terms]
        # ⚡ Bolt: Use executemany to avoid severe N+1 SQLite bottleneck
        conn.executemany(
    ...
    def recall(self, query, top_k=5):
        ...
        # ⚡ Bolt: Pre-calculate query magnitude outside the loop to avoid O(N) redundant calculations
