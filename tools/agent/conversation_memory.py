...
class ConversationMemory:
    ...
    def recall(self, query, top_k=5):
        ...
        matching_rows = []
        all_needed_terms = set(query_tokens)
        ...
        # 2. Load doc frequencies ONLY for needed terms (two-pass approach)
        df_cache = {}
        needed_terms_list = list(all_needed_terms)
        ...
        # 3. Score all matching conversations
        scored = []
