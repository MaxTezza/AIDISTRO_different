...
class ConversationMemory:
    ...
    def recall(self, query, top_k=5):
        ...
        # Two-pass approach:
        # Pass 1: Identify matching documents and collect all unique terms
        matching_docs = []
        matching_notes = []
        all_unique_terms = set(query_terms)
        ...
        # Pass 2: Fetch document frequencies for required terms only
        df_cache = {}
