...
class ConversationMemory:
    ...
    def _cosine_similarity(self, vec_a, vec_b, mag_a=None):
        ...
        mag_a = math.sqrt(sum(v ** 2 for v in vec_a.values())) if mag_a is None else mag_a
    ...
    def recall(self, query, top_k=5):
        ...
        # First pass: collect matching documents and their terms
        rows = conn.execute(
        ...
        for row in rows:
            ...
            unique_terms.update(doc_tokens)
        ...
        # ⚡ Bolt: Cache document frequencies for unique terms in matching docs to avoid full table scan or N+1 queries
        df_cache = {}
