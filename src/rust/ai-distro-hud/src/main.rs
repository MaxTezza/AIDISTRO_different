...
struct AiEvent {
    ...
    title: Option<String>,
    #[serde(default)]
    point: Option<String>, // Format: "x,y"
}
...
impl eframe::App for HudApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        visuals.window_fill = egui::Color32::TRANSPARENT; // Full transparency
        ctx.set_visuals(visuals);

        // Draw Highlights (Augmentation)
            ...
            if let Some(point_str) = &event.point {
                ...
                if parts.len() == 2 {
                    ...
                    painter.circle_stroke(
                        egui::pos2(x, y),
                        radius,
                        egui::Stroke::new(3.0, egui::Color32::from_rgba_unmultiplied(0, 255, 100, alpha))
                    );
        ...
        // Constant repaint for real-time updates
        ctx.request_repaint();
    }
}
...
fn main() -> Result<(), eframe::Error> {
    ...
    // Background thread for WebSockets
    ...
    let options = eframe::NativeOptions {
        viewport: egui::ViewportBuilder::default()
            ...
            .with_always_on_top()
            .with_maximized(true) // Full screen overlay
            .with_active(false)    // Don't steal focus
            .with_mouse_passthrough(true), // Click through the overlay
        ..Default::default()
    };
